...
export const ROTEIRO: HelpStep[] = [
  ...
  },
  {
    ...
    texto: 'Em Gerar, use “Tema livre + amarra” (ou “A partir da seleção”). Anexe txt/md/html/imagem/PDF. Há um campo por atividade e, no roteiro, “Refazer esta”. O cronograma segue o formulário de papel: horário, duração, item e responsável. O roteiro guarda o pedido; dá para regenerar sem redigitar. O roteiro salvo vai a Roteiros e amarra na Agenda.',
  },
  {
...
export const TELA_HELP: Record<string, ScreenHelp> = {
  ...
  GENERATOR: {
    ...
    dicas: [
      ...
      'Um campo por atividade (semente). No roteiro gerado, “Refazer esta” refaz só aquela faixa. O roteiro guarda o pedido; dá para regenerar sem redigitar.',
...
export const FAQ: HelpFaq[] = [
  ...
  },
  {
    ...
    a: 'Gerar → “Tema livre + amarra” (ou marque itens e use “A partir da seleção”). Preencha tema, cronograma (horário, duração, item, responsável), um campo por atividade se quiser, e anexos. “✨ Gerar Roteiro”. No resultado, “Refazer esta” refaz uma faixa. O roteiro guarda o pedido; dá para regenerar sem redigitar. O roteiro salvo aparece em Roteiros e na Agenda.',
  },
  {
