...
export const ROTEIRO: HelpStep[] = [
  ...
  },
  {
    ...
    texto: 'Em Gerar, monte o cronograma e preencha diretamente cada atividade: nome, objetivo curto, descrição detalhada, materiais, progressão e informações para a chefia. Salve sem IA ou use “Completar com IA” como apoio opcional. O roteiro salvo vai a Roteiros e pode ser ligado à Agenda.',
  },
  {
...
export const TELA_HELP: Record<string, ScreenHelp> = {
  ...
  GENERATOR: {
    ...
    corpo: 'Monta a reunião a partir do cronograma e dos detalhes essenciais de cada atividade. A IA é um apoio opcional.',
    dicas: [
