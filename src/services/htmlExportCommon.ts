...
.por{display:block;width:100%;max-width:100%;min-width:0;margin:8px 0 0;white-space:normal;overflow:visible;overflow-wrap:anywhere;word-break:break-word;color:#4338ca;font-weight:600}
.pill{white-space:normal;overflow-wrap:anywhere;max-width:100%}
.ready{background:#fff7ed;border-color:#fdba74}.steps{width:100%;border-collapse:collapse;font-size:13px;margin-top:8px}.steps td{border-bottom:1px solid var(--line);padding:6px 8px;vertical-align:top}.clock-cell{width:7.5rem;font-weight:800;white-space:nowrap;color:var(--brand)}
.seed{margin:28px;padding:18px;border:2px dashed #b45309;border-radius:16px;background:#fffbeb}.seed h2{margin:0 0 8px;border:0;padding:0;color:#9a3412}.seed pre{white-space:pre-wrap;word-break:break-word;background:#fff;border:1px solid #fde68a;border-radius:10px;padding:14px;font-size:13px;line-height:1.5}
